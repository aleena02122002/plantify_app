            ...
            children: [
              Container(
                child: Align(
                  ...
                  child: Image.asset('images/Group 73.png'),
                ),
              ),
              const SizedBox(
                height: 10,
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        right: 30,
                        top: 20,
                        child: Image.asset('images/1plant.png'),
                      )
                    ],
                  )),
              const SizedBox(
              ...
              CustomInkWell(
                  child: Image.asset('images/Group 81.png'), onTap: () {}),
              const SizedBox(
                height: 10,
              ),
              InkWell(
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        right: 30,
                        top: 20,
                        child: Image.asset('images/2plant.png'),
                      )
                    ],
                  )),
            ],
